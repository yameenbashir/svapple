...
function headerTypeChange($header){
	...
	var $this = $(this),
		...
		switch($header){
			...
			case "header-home1" :
				url = "resources/header/header1-container.html";
				type = 'type_1';
				headerStyle ='resources/css/header1.css';
				break;

			case "header-home2" :
				url = "resources/header/header2-container.html";
				type = 'type_2';
				headerStyle ='resources/css/header2.css';
				break;

			case "header-home3" :
				url = "resources/header/header3-container.html";
				type = 'type_3';
				headerStyle ='resources/css/header3.css';
				break;

			case "header-home4" :
				url = "resources/header/header4-container.html";
				type = 'type_4';
				headerStyle ='resources/css/header4.css';
				break;
			
			case "header-home5" :
				url = "resources/header/header5-container.html";
				type = 'type_5';
				headerStyle ='resources/css/header5.css';
				break;
				
			case "header-home6" :
				url = "resources/header/header6-container.html";
				type = 'type_6';
				headerStyle ='resources/css/header6.css';
				break;
			
			case "header-home7" :
				url = "resources/header/header7-container.html";
				type = 'type_7';
				headerStyle ='resources/css/header7.css';
				break;
			
			case "header-home8" :
				url = "resources/header/header8-container.html";
				type = 'type_8';
				headerStyle ='resources/css/header8.css';
				break;
		}
		...
		$.getScript('resources/js/themejs/so_megamenu.js', function() {
			//console.log('Load was performed.');
		});
		$.getScript('resources/js/themejs/application.js', function() {
			//console.log('Load was performed.');
		});
