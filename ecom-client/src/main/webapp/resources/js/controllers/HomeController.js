 ...
 * @constructor
 */
var HomeController = function($scope, $http, $window,$cookieStore,$rootScope,$timeout,HomeControllerPreLoad) {
	...
	$rootScope.homeBean = HomeControllerPreLoad.loadControllerData();
	...
	$rootScope.showProducts = function(productCategory){
		$rootScope.productTypeId = productCategory.productTypeId;
		$rootScope.productTypeName = productCategory.productTypeName;
		$window.location = '/ecom/#/category';
