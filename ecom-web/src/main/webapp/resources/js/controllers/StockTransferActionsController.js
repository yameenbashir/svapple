...
/**
 * StockTransferActionsController
 * @constructor
 */
var StockTransferActionsController = ['$scope', '$http', '$window', '$timeout', '$cookieStore', '$route', '$rootScope', 'SessionService','StockTransferActionsControllerPreLoad',function($scope, $http, $window, $timeout, $cookieStore, $route, $rootScope, SessionService,StockTransferActionsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.data = StockTransferActionsControllerPreLoad.loadControllerData();
			$scope.fetchData();
	...
	$scope.fetchData = function() {
		$rootScope.stockTransferActionsLoadedFully = false;
