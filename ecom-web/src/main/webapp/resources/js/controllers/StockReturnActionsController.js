...
/** 
 * StockReturnActionsController
 * @constructor
 */
var StockReturnActionsController = ['$scope', '$http', '$window', '$timeout', '$cookieStore', '$route', '$rootScope', 'SessionService','StockReturnActionsControllerPreLoad',function($scope, $http, $window, $timeout, $cookieStore, $route, $rootScope, SessionService,StockReturnActionsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.isAdmin();
			$scope.data = StockReturnActionsControllerPreLoad.loadControllerData();
			$scope.fetchData();
