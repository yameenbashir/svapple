 ...
 * @constructor
 */
var DownloadProductsController = ['$scope', '$http','$sce', '$window','$cookieStore','$rootScope','SessionService','DownloadProductsControllerPreLoad',function($scope, $http,$sce, $window,$cookieStore,$rootScope,SessionService,DownloadProductsControllerPreLoad) {
	...
	$scope.fetchData = function(){
		DownloadProductsControllerPreLoad.loadControllerData();
