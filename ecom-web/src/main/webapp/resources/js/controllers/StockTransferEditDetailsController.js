 ...
 * @constructor
 */
var StockTransferEditDetailsController = ['$scope', '$http', '$timeout', '$window','$cookieStore','$rootScope','SessionService','StockTransferEditDetailsControllerPreLoad',function($scope, $http, $timeout, $window,$cookieStore,$rootScope,SessionService,StockTransferEditDetailsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.data = StockTransferEditDetailsControllerPreLoad.loadControllerData();
			$scope.fetchData();
	...
	$scope.fetchData = function() {
		$rootScope.stockTransferEditDetailsLoadedFully = false;
