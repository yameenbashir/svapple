...
/**
 * SalesReportCurrentDateController
 * @constructor
 */

var SalesReportCurrentDateController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','SalesReportCurrentDateControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,SalesReportCurrentDateControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if(SessionService.validate()){
			...
			$scope.data = SalesReportCurrentDateControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
