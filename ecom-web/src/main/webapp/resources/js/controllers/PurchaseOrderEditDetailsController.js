 ...
 * @constructor
 */
var PurchaseOrderEditDetailsController = ['$scope', '$http', '$timeout', '$window','$cookieStore','$rootScope','SessionService','PurchaseOrderEditDetailsControllerPreLoad',function($scope, $http, $timeout, $window,$cookieStore,$rootScope,SessionService,PurchaseOrderEditDetailsControllerPreLoad) {
	...
	$scope.sessionValidation = function(){
		...
		if(SessionService.validate()){
			...
			$scope.data = PurchaseOrderEditDetailsControllerPreLoad.loadControllerData();
			$scope.fetchData();
	...
	$scope.fetchData = function() {
		$rootScope.purchaseOrderEditDetailsLoadedFully = false;
