...
/**
 * InventoryReportLiveController
 * @constructor
 */

var InventoryReportLiveController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','InventoryReportLiveControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,InventoryReportLiveControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if(SessionService.validate()){
			...
			$scope.data = InventoryReportLiveControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
