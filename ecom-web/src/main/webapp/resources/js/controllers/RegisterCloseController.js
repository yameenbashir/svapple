 ...
 * @constructor
 */
var RegisterCloseController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','RegisterCloseControllerPreLoad','$timeout','$route',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,RegisterCloseControllerPreLoad,$timeout,$route) {
	...
	$scope.sesssionValidation = function() {
		...
		if (SessionService.validate()) {
			...
			$scope.controllerBean = RegisterCloseControllerPreLoad.loadControllerData();
