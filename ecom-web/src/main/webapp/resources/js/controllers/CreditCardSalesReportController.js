...
/**
 * CreditCardSalesReportController
 * @constructor
 */

var CreditCardSalesReportController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','CreditCardSalesReportControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,CreditCardSalesReportControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if($rootScope.salesReportDateType == "weekly"){
			...
			$scope.data = CreditCardSalesReportControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
