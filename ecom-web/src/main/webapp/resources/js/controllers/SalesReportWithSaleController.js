...
/**
 * SalesReportWithSaleController
 * @constructor
 */

var SalesReportWithSaleController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','SalesReportWithSaleControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,SalesReportWithSaleControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if($rootScope.salesReportDateType == "weekly"){
			...
			$scope.data = SalesReportWithSaleControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
