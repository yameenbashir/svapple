...
public class StockOrderBean {
	...
	private String sourceOutletAddress;
	...
	/**
	 * @return the recItemCount
	 */
	public String getRecItemCount() {
		return recItemCount;
	}

	/**
	 * @param recItemCount the recItemCount to set
	 */
	public void setRecItemCount(String recItemCount) {
		this.recItemCount = recItemCount;
	}
	...
	/**
	 * @return the sourceOutletAddress
	 */
	public String getSourceOutletAddress() {
		return sourceOutletAddress;
	}

	/**
	 * @param sourceOutletAddress the sourceOutletAddress to set
	 */
