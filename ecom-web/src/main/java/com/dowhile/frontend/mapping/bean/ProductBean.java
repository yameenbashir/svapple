...
public class ProductBean {
	...
	/**
	 * @return the productPriceHistoryBean
	 */
	public ProductPriceHistoryBean getProductPriceHistoryBean() {
		return productPriceHistoryBean;
	}

	/**
	 * @param productPriceHistoryBean the productPriceHistoryBean to set
	 */
