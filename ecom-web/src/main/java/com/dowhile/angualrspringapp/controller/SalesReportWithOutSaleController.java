...
public class SalesReportWithOutSaleController {
	...
	private static Logger logger = Logger.getLogger(SalesReportWithOutSaleController.class.getName());
	@Resource
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(isLiveData!=null && !isLiveData.equalsIgnoreCase("") && isLiveData.equalsIgnoreCase("true")||isLocalInstance){
					tableName = new StringBuilder("SaleReport_withOutSale");
				}else{
					tableName = new StringBuilder("mv_SaleReport_withOutSale");
				}
