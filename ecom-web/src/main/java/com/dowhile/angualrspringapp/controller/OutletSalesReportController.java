...
public class OutletSalesReportController {
	...
	private static Logger logger = Logger.getLogger(OutletSalesReportController.class.getName());
	@Resource
	...
	@RequestMapping(value = "/getOutletSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}/{isLiveData}", method = RequestMethod.POST)
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(isLiveData!=null && !isLiveData.equalsIgnoreCase("") && isLiveData.equalsIgnoreCase("true")||isLocalInstance){
					tableName = new StringBuilder("Outlet_Sales_Report");
				}else{
					tableName = new StringBuilder("mv_Outlet_Sales_Report");
				}
