...
public class SalesReportWithSaleController {
	...
	// private static Logger logger = Logger.getLogger(SalesReportWithSaleController.class.getName());
	@Resource
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(isLiveData!=null && !isLiveData.equalsIgnoreCase("") && isLiveData.equalsIgnoreCase("true")||isLocalInstance){
					tableName = new StringBuilder("Salereport_withsale");
				}else{
					tableName = new StringBuilder("mv_SaleReport_withSale");
				}
