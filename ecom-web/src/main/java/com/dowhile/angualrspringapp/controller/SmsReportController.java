...
public class SmsReportController {
	...
	// private static Logger logger = Logger.getLogger(SmsReportController.class.getName());
	@Resource
	...
	@RequestMapping(value = "/getSmsReportControllerDataByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
	public @ResponseBody Response getSmsReportControllerDataByDateRange(@PathVariable("sessionId") String sessionId,
			...
			try {
				...
				TableData tableData = null;
					...
					if(!isHeadOffice && configuration!=null && configuration.getPropertyValue().toString().equalsIgnoreCase(ControllersConstants.TRUE)){
						reportParams.setBaseColumn("MESSAGE_DETAIL_ID,SENDER_ID,RECEIVER_ID,MESSAGE_DESCRIPTION,DELIVERY_ID,DELIVERY_STATUS");
						reportParams.setPrintColumns( "MESSAGE_DETAIL_ID,SENDER_ID,RECEIVER_ID,MESSAGE_DESCRIPTION,DELIVERY_ID,DELIVERY_STATUS");
					}else{
						reportParams.setBaseColumn("MESSAGE_DETAIL_ID,SENDER_ID,RECEIVER_ID,MESSAGE_DESCRIPTION,DELIVERY_ID,DELIVERY_STATUS");
						reportParams.setPrintColumns( "MESSAGE_DETAIL_ID,SENDER_ID,RECEIVER_ID,MESSAGE_DESCRIPTION,DELIVERY_ID,DELIVERY_STATUS");
					}
					...
					reportParams.setGroupBy("MESSAGE_DETAIL_ID");
					reportParams.setMainBaseColumn("MESSAGE_DETAIL_ID");
					...
					reportParams.setTableName("sms_report");
					reportParams.setTallyColumn("MESSAGE_DETAIL_ID");
					if(completeReport){
