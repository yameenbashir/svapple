...
public class CreditCardSalesReportController {
	...
	@RequestMapping(value = "/getCreditCardSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}/{isLiveData}", method = RequestMethod.POST)
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(isLiveData!=null && !isLiveData.equalsIgnoreCase("") && isLiveData.equalsIgnoreCase("true")||isLocalInstance){
					tableName = new StringBuilder("credit_sale");
				}else{
					tableName = new StringBuilder("mv_credit_sale");
				}
