...
public class UserSalesReportController {
	...
	// private static Logger logger = Logger.getLogger(UserSalesReportController.class.getName());
	@Resource
	...
	@RequestMapping(value = "/getUserSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}/{isLiveData}", method = RequestMethod.POST)
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(isLiveData!=null && !isLiveData.equalsIgnoreCase("") && isLiveData.equalsIgnoreCase("true")||isLocalInstance){
					tableName = new StringBuilder("User_Sales_Report");
				}else{
					tableName = new StringBuilder("mv_User_Sales_Report");
				}
