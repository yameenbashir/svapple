 ...
 */
@Controller
@RequestMapping("/brandSalesReport")
public class BrandSalesReportController {

	// private static Logger logger = Logger.getLogger(BrandSalesReportController.class.getName());
	@Resource
...
//				configuration = configurationMap.get("HIDE_ORIGNAL_PRICE_INFO_REPORTS");
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setGroupBy("Brand");
						reportParams.setMainBaseColumn("Brand");
				...
				if (tableData != null) {
					...
					util.AuditTrail(request, currentUser, "BrandSalesReportController.getBrandSalesReportByDateRange", 
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(outlets!=null){
					...
					util.AuditTrail(request, currentUser, "BrandSalesReportController.getOutlets", 
