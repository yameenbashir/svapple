 ...
 */
@Controller
@RequestMapping("/supplierSalesReport")
public class SupplierSalesReportController {

	// private static Logger logger = Logger.getLogger(SupplierSalesReportController.class.getName());
	@Resource
	...
	@RequestMapping(value = "/getSupplierSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}/{isLiveData}", method = RequestMethod.POST)
	public @ResponseBody Response getSupplierSalesReportByDateRange(@PathVariable("sessionId") String sessionId,
...
//				configuration = configurationMap.get("HIDE_ORIGNAL_PRICE_INFO_REPORTS");
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setGroupBy("Supplier");
						reportParams.setMainBaseColumn("Supplier");
				...
				if (tableData != null) {
					...
					util.AuditTrail(request, currentUser, "SupplierSalesReportController.getSupplierSalesReportByDateRange", 
					...
					util.AuditTrail(request, currentUser, "SupplierSalesReportController.getSupplierSalesReportByDateRange", 
							" Supplier Sales report is not found requested by User "+currentUser.getUserEmail(),false);
		...
		if(SessionValidator.isSessionValid(sessionId, request)){
			...
			try {
				...
				if(outlets!=null){
					...
					util.AuditTrail(request, currentUser, "SupplierSalesReportController.getOutlets", 
