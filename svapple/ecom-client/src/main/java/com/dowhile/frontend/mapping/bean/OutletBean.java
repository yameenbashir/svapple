...
public class OutletBean {
	...
	public OutletBean(String outletId, String outletName, String defaultTax,
			...
			String retailPrice, String currentInventory, String reorderPoint,
			String reorderAmount, String supplierId, String supplierCode,
			String supplierName, String supplyPriceExclTax, String markupPrct,
			String retailPriceExclTax, String sku) {
