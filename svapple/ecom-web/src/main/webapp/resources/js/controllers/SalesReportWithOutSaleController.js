...
/**
 * SalesReportWithOutSaleController
 * @constructor
 */

var SalesReportWithOutSaleController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','SalesReportWithOutSaleControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,SalesReportWithOutSaleControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if($rootScope.salesReportDateType == "weekly"){
			...
			$scope.data = SalesReportWithOutSaleControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
