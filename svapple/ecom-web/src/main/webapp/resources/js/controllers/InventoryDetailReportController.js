...
/**
 * InventoryDetailReportController.js
 * @constructor
 */

var InventoryDetailReportController = ['$scope', '$http', '$window','$cookieStore','$rootScope','SessionService','$timeout','$interval','$route','$filter','InventoryDetailReportControllerPreLoad',function($scope, $http, $window,$cookieStore,$rootScope,SessionService,$timeout,$interval,$route,$filter,InventoryDetailReportControllerPreLoad) {
	...
	$scope.sesssionValidation = function(){
		if(SessionService.validate()){
			...
			$scope.data = InventoryDetailReportControllerPreLoad.loadControllerData();
			$scope.fetchData();
		}
	};
