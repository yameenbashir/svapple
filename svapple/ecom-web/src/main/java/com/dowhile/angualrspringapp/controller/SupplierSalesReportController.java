...
public class SupplierSalesReportController {
	...
	@RequestMapping(value = "/getSupplierSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
			...
			try {
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setTableName("Supplier_Sales_Report");
