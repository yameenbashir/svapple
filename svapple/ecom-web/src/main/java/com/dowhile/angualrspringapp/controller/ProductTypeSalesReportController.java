...
public class ProductTypeSalesReportController {
	...
	@RequestMapping(value = "/geProductTypeSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
			...
			try {
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setTableName("ProductType_Sales_Report");
