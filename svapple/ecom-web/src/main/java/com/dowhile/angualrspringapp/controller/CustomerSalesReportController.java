...
public class CustomerSalesReportController {
	...
	@RequestMapping(value = "/getCustomerSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
			...
			try {
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setTableName("Customer_Sales_Report");
