...
public class CustomerGroupSalesReportController {
	...
	@RequestMapping(value = "/getCustomerGroupSalesReportByDateRange/{sessionId}/{startDate}/{endDate}/{reportType}/{reportDateType}/{outletName}", method = RequestMethod.POST)
			...
			try {
				...
				if(reportType.equals("Revenue")){
					ReportParams reportParams = new ReportParams();
						...
						reportParams.setTableName("Customer_Group_Sales_Report");
