...
/**
 * InventoryReport generated by hbm2java
 */
@Entity
@Table(name="Inventory_Report"
    ,catalog="ecom"
)
public class InventoryReport  implements java.io.Serializable {


     private InventoryReportId id;

    public InventoryReport() {
    }

    public InventoryReport(InventoryReportId id) {
       this.id = id;
    }
    ...
    public InventoryReportId getId() {
        return this.id;
    }
    
    public void setId(InventoryReportId id) {
        this.id = id;
    }
