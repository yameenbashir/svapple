...
/**
 * InventoryReportId generated by hbm2java
 */
@Embeddable
public class InventoryReportId  implements java.io.Serializable {
    ...
    public InventoryReportId() {
    }

	
    public InventoryReportId(int id, String sku, BigDecimal supplyPriceExclTax, BigDecimal markupPrct, int outletAssocicationId, Date createdDate, int companyAssociationId) {
        this.id = id;
        this.sku = sku;
    ...
    public InventoryReportId(int id, String productName, String sku, BigDecimal supplyPriceExclTax, BigDecimal markupPrct, Long reorderPoint, BigDecimal reorderAmount, Integer currentInventory, BigDecimal netPrice, String outletName, int outletAssocicationId, Date createdDate, String brandName, String productType, String contactName, int companyAssociationId, BigDecimal stockValue, BigDecimal retailValue) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof InventoryReportId) ) return false;
		 InventoryReportId castOther = ( InventoryReportId ) other; 
